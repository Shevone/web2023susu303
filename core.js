...
function getOperationFn(initialValue, operatorFn) {
    ...
    // Возвращаем функцию операции, которая обновляет storedValue
...
function deepEqual(firstObject, secondObject) {
    // Если оба аргумента - примитивы, сравниваем их просто
    ...
    // Если пройдены все проверки, объекты равны
    return true;
}
